...
const EditServiceOrder: React.FC = () => {
    ...
    const handleEditServiceOrder = async (formData: FormData) => {
        try {
            const response = await axios.patch(`${import.meta.env.VITE_API_URL}/service-order/${id}`, formData, {
