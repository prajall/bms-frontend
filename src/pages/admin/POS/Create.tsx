...
import { CustomerOption } from "@/components/formElements/CustomerSelect";
...
export default function POSPage() {
  ...
  const [customer, setCustomer] = useState<CustomerOption>({
    value: '67554286140992b96228ae97',
  ...
  const handleCustomerChange = (option: SingleValue<CustomerOption>) => {
    if (option) {
      ...
      setSelectedCustomer("67554286140992b96228ae97");
      setCustomer({value: '67554286140992b96228ae97', label: 'Walking Customer', image: ''});
    }
  };
